...
h = pd.read_csv('/home/damoncrockett/vosd.org/215-opendsd/hood_polygons.csv')
...
for i in range(100001, n):
    ...
    print i
    if i == 200000:
	pd.DataFrame(hood_polygons).to_csv('/home/damoncrockett/vosd.org/215-opendsd/hood_polygons_2.csv')	
    if i == 300000:
	pd.DataFrame(hood_polygons).to_csv('/home/damoncrockett/vosd.org/215-opendsd/hood_polygons_2.csv')
